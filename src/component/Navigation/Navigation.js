  ...
  render() {
    if(this.props.signedStatus === "signedIn"){
      return(
        ...
        <Button>
          <button onClick={this.changeStatus} value='signedOut' >SignOut</button>
        </Button>
      </Nav>
      )
    }
      ...
      return (
        ...
        <Title>Face recognition</Title>
        <Button>
          <button onClick={this.changeStatus} value='signedOut' >SignIn</button>
        </Button>
      </Nav>
    );
  }
    ...
    return (
      ...
      <Title>Face recognition</Title>
      <Button>
        <button onClick={this.changeStatus} value='register' >Register</button>
      </Button>
    </Nav>
  );
}
